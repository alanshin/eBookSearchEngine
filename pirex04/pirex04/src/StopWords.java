...
/**
 * StopWords class that incorporates stop words from being entered into the index algorithm
 * in order to shorten searching speed.
 * 
...
public final class StopWords
{
  ...
  /**
   * StopWords function that provides a string array of stop words.
   * 
   * @return stopWordsArray which is a string array of known/included terms.
   */
  public static String[] stopWords()
  {
    stopWordsArray = new String[] {"a", "about", "above", "after", "again", "against", 
